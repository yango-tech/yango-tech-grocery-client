...
class TestRateLimiter(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_rate_limiter_cleanup_old_requests(self):
        ...
        self.assertLess(elapsed, 0.1, f"Expected immediate execution after cleanup")
    ...
    async def test_rate_limiter_immediate_execution_after_partial_window(self):
        ...
        self.assertLess(request_elapsed, 0.01, f"Expected immediate execution")
